...
enum oct_elementType
{
    ...
    OCT_ELEMENT_TYPE_FLOAT_FOUR,
    OCT_ELEMENT_TYPE_INT_ONE,
    OCT_ELEMENT_TYPE_HALF_TWO_NORM,
    OCT_ELEMENT_TYPE_HALF_FOUR_NORM,
    OCT_ELEMENT_TYPE_UBYTE_FOUR,
    OCT_ELEMENT_TYPE_UBYTE_FOUR_NORM,
    OCT_ELEMENT_TYPE_PVEC_THREE,
    OCT_ELEMENT_TYPE_HALF_TWO,
    OCT_ELEMENT_TYPE_HALF_FOUR,
    OCT_ELEMENT_TYPE_MAX
};
